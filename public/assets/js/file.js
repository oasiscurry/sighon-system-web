...
function initNoticesText () {
  const aryNoticesText = [
    {
      txt_path: '../assets/txt/jquery-3.4.1.min.js.txt',
      id: 'jquery-3.4.1.min.js.id'
    },
    {
      txt_path: '../assets/txt/bootstrap.bundle.min.js.txt',
      id: 'bootstrap.bundle.min.js.id'
    },
    {
      txt_path: '../assets/txt/three.min.js.txt',
      id: 'three.min.js.id'
    },
    {
      txt_path: '../assets/txt/draco_decoder.js.txt',
