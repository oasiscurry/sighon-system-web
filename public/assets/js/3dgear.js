...
const MODEL_DATA_PATH = '../assets/models/gear3d.glb' // モデルデータのパス
const DRACO_DECODER_PATH = '../assets/js/lib/' // Dracoデコーダのパス
const DEBUG_MODE = false // デバッグのオン(true)オフ(false)
const ENV_MAP = [
  // 環境マップ用テクスチャのパス
  '../assets/textures/envmap/posx.jpg',
  '../assets/textures/envmap/negx.jpg',
  '../assets/textures/envmap/posy.jpg',
  '../assets/textures/envmap/negy.jpg',
  '../assets/textures/envmap/posz.jpg',
  '../assets/textures/envmap/negz.jpg'
]
const MODEL_DATA = [
  // モデルデータのパラメータ
 ...
 * 初期化
 * ****************************************************************************/
// window.addEventListener('DOMContentLoaded', init3DGear)
// $(window).on('DOMContentLoaded', init3DGear)
$(init3DGear)
